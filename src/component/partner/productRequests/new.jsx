...
import { resetState, setNewProductRequest } from '../../../redux/productRequests/action';
import { Form, Input, Button, Row, Col, Breadcrumb, Upload, message } from 'antd';
import { Redirect } from 'react-router';
import { UploadOutlined } from '@ant-design/icons';

const NewProductRequest = ({ result, setNewProductRequest, resetState }) => {
    ...
    return result === true ? <Redirect to="/urun-taleplerim" /> : (
        <div>
...
const mapStateToProps = (state) => {
    return {
        result: state.productRequests.newProductRequestResult,
    }
}

const mapDispatchToProps = (dispatch) => {
    return {
        setNewProductRequest: (productRequest) => dispatch(setNewProductRequest(productRequest)),
