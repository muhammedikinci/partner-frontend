...
import { updateMyData, getMyData, resetState } from '../../../redux/customer/action';
import { Form, Input, Button, Row, Col, message, Breadcrumb } from 'antd';

const PartnerProfileEdit = ({ getMyData, result, updateMyData, resetState, partner }) => {
    useEffect(() => {
        getMyData()
    ...
    return (
        <div>
            <Breadcrumb style={{ margin: '16px 0' }}>
                ...
                <Breadcrumb.Item>Profili Düzenle</Breadcrumb.Item>
            </Breadcrumb>
            <Form
                    name="basic"
                    layout="vertical"
...
const mapDispatchToProps = (dispatch) => {
    return {
        updateMyData: (partner) => dispatch(updateMyData(partner)),
